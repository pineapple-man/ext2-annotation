...
#define ext2_debug(f, a...)                                              \
  {                                                                      \
    printk("EXT2-fs DEBUG (%s, %d): %s:", __FILE__, __LINE__, __func__); \
    printk(f, ##a);                                                      \
  }
#else
#define ext2_debug(f, a...) /**/
...
#define EXT2_FL_INHERITED                                                 \
  (EXT2_SECRM_FL | EXT2_UNRM_FL | EXT2_COMPR_FL | EXT2_SYNC_FL |          \
   EXT2_NODUMP_FL | EXT2_NOATIME_FL | EXT2_COMPRBLK_FL | EXT2_NOCOMP_FL | \
   EXT2_JOURNAL_DATA_FL | EXT2_NOTAIL_FL | EXT2_DIRSYNC_FL)
...
static inline ext2_fsblk_t ext2_group_last_block_no(struct super_block *sb,
  ...
  if (group_no == sbi->s_groups_count - 1)
    ...
    return ext2_group_first_block_no(sb, group_no) + EXT2_BLOCKS_PER_GROUP(sb) -
           1;
}
